...
func (lc *litAfClient) History(textArgs []string) error {
	...
	err := lc.rpccon.Call(lc.peerId, "", "LitRPC.StateDump", args, reply)
	if err != nil {
		return err
	}
...
func (lc *litAfClient) FundChannel(textArgs []string) error {
	...
	err = lc.rpccon.Call(lc.peerId, "", "LitRPC.FundChannel", args, reply)
	if err != nil {
		return err
	}
...
func (lc *litAfClient) CloseChannel(textArgs []string) error {
	...
	err = lc.rpccon.Call(lc.peerId, "", "LitRPC.CloseChannel", args, reply)
	if err != nil {
		return err
	}
...
func (lc *litAfClient) BreakChannel(textArgs []string) error {
	...
	err = lc.rpccon.Call(lc.peerId, "", "LitRPC.BreakChannel", args, reply)
	if err != nil {
		return err
	}
...
func (lc *litAfClient) Push(textArgs []string) error {
	...
	for times > 0 {
		err := lc.rpccon.Call(lc.peerId, "", "LitRPC.Push", args, reply)
		if err != nil {
			return err
		}
...
func (lc *litAfClient) Dump(textArgs []string) error {
	...
	err := lc.rpccon.Call(lc.peerId, "", "LitRPC.DumpPrivs", pArgs, pReply)
	if err != nil {
		return err
	}
...
func (lc *litAfClient) Watch(textArgs []string) error {
	...
	err = lc.rpccon.Call(lc.peerId, "", "LitRPC.Watch", args, reply)
	if err != nil {
		return err
	}
