...
func (lc *litAfClient) DlcListOracles(textArgs []string) error {
	...
	err := lc.rpccon.Call(lc.peerId, "", "LitRPC.ListOracles", args, reply)
	if err != nil {
		return err
	}
...
func (lc *litAfClient) DlcImportOracle(textArgs []string) error {
	...
	err := lc.rpccon.Call(lc.peerId, "", "LitRPC.ImportOracle", args, reply)
	if err != nil {
		return err
	}
...
func (lc *litAfClient) DlcAddOracle(textArgs []string) error {
	...
	err := lc.rpccon.Call(lc.peerId, "", "LitRPC.AddOracle", args, reply)
	if err != nil {
		return err
	}
...
func (lc *litAfClient) DlcListContracts(textArgs []string) error {
	...
	err := lc.rpccon.Call(lc.peerId, "", "LitRPC.ListContracts", args, reply)
	if err != nil {
		return err
	}
...
func (lc *litAfClient) DlcNewContract(textArgs []string) error {
	...
	err := lc.rpccon.Call(lc.peerId, "", "LitRPC.NewContract", args, reply)
	if err != nil {
		return err
	}
...
func (lc *litAfClient) DlcViewContract(textArgs []string) error {
	...
	err = lc.rpccon.Call(lc.peerId, "", "LitRPC.GetContract", args, reply)
	if err != nil {
		return err
	}
...
func (lc *litAfClient) DlcSetContractOracle(textArgs []string) error {
	...
	err = lc.rpccon.Call(lc.peerId, "", "LitRPC.SetContractOracle", args, reply)
	if err != nil {
		return err
	}
...
func (lc *litAfClient) DlcSetContractDatafeed(textArgs []string) error {
	...
	err = lc.rpccon.Call(lc.peerId, "", "LitRPC.SetContractDatafeed", args, reply)
	if err != nil {
		return err
	}
...
func (lc *litAfClient) DlcSetContractRPoint(textArgs []string) error {
	...
	err = lc.rpccon.Call(lc.peerId, "", "LitRPC.SetContractRPoint", args, reply)
	if err != nil {
		return err
	}
...
func (lc *litAfClient) DlcSetContractSettlementTime(textArgs []string) error {
	...
	err = lc.rpccon.Call(lc.peerId, "", "LitRPC.SetContractSettlementTime", args, reply)
	if err != nil {
		return err
	}
...
func (lc *litAfClient) DlcSetContractFunding(textArgs []string) error {
	...
	err = lc.rpccon.Call(lc.peerId, "", "LitRPC.SetContractFunding", args, reply)
	if err != nil {
		return err
	}
...
func (lc *litAfClient) DlcSetContractCoinType(textArgs []string) error {
	...
	err = lc.rpccon.Call(lc.peerId, "", "LitRPC.SetContractCoinType", args, reply)
	if err != nil {
		return err
	}
...
func (lc *litAfClient) DlcSetContractDivision(textArgs []string) error {
	...
	err = lc.rpccon.Call(lc.peerId, "", "LitRPC.SetContractDivision", args, reply)
	if err != nil {
		return err
	}
...
func (lc *litAfClient) DlcOfferContract(textArgs []string) error {
	...
	err = lc.rpccon.Call(lc.peerId, "", "LitRPC.OfferContract", args, reply)
	if err != nil {
		return err
	}
...
func (lc *litAfClient) DlcDeclineContract(textArgs []string) error {
	...
	err = lc.rpccon.Call(lc.peerId, "", "LitRPC.DeclineContract", args, reply)
	if err != nil {
		return err
	}
...
func (lc *litAfClient) DlcAcceptContract(textArgs []string) error {
	...
	err = lc.rpccon.Call(lc.peerId, "", "LitRPC.AcceptContract", args, reply)
	if err != nil {
		return err
	}
...
func (lc *litAfClient) DlcSettleContract(textArgs []string) error {
	...
	err = lc.rpccon.Call(lc.peerId, "", "LitRPC.SettleContract", args, reply)
	if err != nil {
		return err
	}
